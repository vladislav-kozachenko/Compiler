...
public class CycleParserFactory {

    private final Map<CycleState, SourceCodeParser> parsers = new HashMap<CycleState, SourceCodeParser>() {{
    ...
    public  SourceCodeParser getParser(CycleState state) {
